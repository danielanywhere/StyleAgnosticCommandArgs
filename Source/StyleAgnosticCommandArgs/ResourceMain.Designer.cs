...
namespace StyleAgnosticCommandArgs {
    ...
    internal class ResourceMain {
        ...
        /// <summary>
        ///   Looks up a localized string similar to (?i:(/|--){0,1}((?&lt;name&gt;[a-z0-9-_]+)\:\s*){0,1}(?&lt;value&gt;.+)).
        /// </summary>
        internal static string rxParamNameValue {
            get {
                return ResourceManager.GetString("rxParamNameValue", resourceCulture);
            }
        }
    }
}
